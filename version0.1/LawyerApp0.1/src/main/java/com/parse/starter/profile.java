...
public class profile extends AppCompatActivity {
    String una,h,s="";ScrollView r3;
    Intent intent = getIntent();
    TextView namez,locationz,almaz,numberz,emailz,specialz,expz;
    TextView namey,locationy,financey,emaily,yearsy,numbery,blank;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (x1 == 'l') {
           ...
           // Lupdate2 =findViewById(R.id.Lupdatex);
            ...
            yearsy = findViewById(R.id.line3);
            locationy = findViewById(R.id.line2);
